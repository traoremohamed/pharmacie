                ...
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ route('creerlogo') }}" class="btn btn-sm btn-primary font-weight-bolder">
                            <i class="la la-plus"></i>Ajouter une logo</a>
                        @endcan
                        <!--end::Button-->
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <?php }else{ ?>
                                    ...
                                    <label class="label label-lg label-success label-inline"><a href="{{ route('activelogo',\App\Helpers\Crypt::UrlCrypt($logo->id_logo )) }}"> Active </a></label>
