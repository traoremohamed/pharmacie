                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            ...
                            {!! Form::text('lien_produit', null, array('placeholder' => 'Lien du produit','class' => 'form-control')) !!}

                            <span class="form-text text-muted">  </span>
                        </div>
                        <div class="col-lg-6">
                            <label>Description:</label>
                            <textarea class="summernote" id="description_produit" name="description_produit" rows="6"></textarea>
