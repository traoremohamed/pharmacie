                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            {!! Form::text('libelle_stat', null, array('placeholder' => 'Nom du personnel','class' => 'form-control','required' => 'required')) !!}
                        ...
                        <div class="col-lg-6">
                            ...
                            {!! Form::text('stat_stat', null, array('placeholder' => 'Fonction','class' => 'form-control','required' => 'required')) !!}
