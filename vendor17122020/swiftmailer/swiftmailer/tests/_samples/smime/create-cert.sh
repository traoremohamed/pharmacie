...
openssl req -new -key sign.key -subj '/CN=Swiftmailer-User19102021/O=Swiftmailer/L=Paris/C=FR' -out sign.csr
...
openssl req -new -key encrypt.key -subj '/CN=Swiftmailer-User19102021/O=Swiftmailer/L=Paris/C=FR' -out encrypt.csr
